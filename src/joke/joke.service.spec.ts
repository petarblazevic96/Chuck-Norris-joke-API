...
describe('UsersService', () => {
        ...
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                JokeService,
                {
                    ...
                    useValue: {
                        add: jest.fn(async (name: string, data: any, opts: Bull.JobOptions) => { }),
                        process: jest.fn()
                    }
                }
            ],
    ...
    it("should not fail", async () => {
        ...
        const httpSpy = jest.spyOn(service["httpService"], "get").mockReturnValue(of(response));
    ...
    it("should throw internal server error", async () => {
        try {
            const httpSpy = jest.spyOn(service["httpService"], "get").mockReturnValue(throwError(() => new Error("Error")));
